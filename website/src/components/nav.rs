        ...
        <nav class="fixed top-0 left-0 right-0 z-50 bg-[rgba(10,10,15,0.9)] backdrop-blur-xl border-b border-[var(--border-color)]">
            <div class="container flex items-center justify-between py-4">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <a href="https://github.com/maluwaf/maluwaf" target="_blank" rel="noopener noreferrer" class="text-[var(--text-secondary)] no-underline font-medium transition-colors hover:text-[var(--accent-primary)]">{"GitHub"}</a>
