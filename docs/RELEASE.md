...
| wasmtime 47.0.4 (via yara-x 1.20 compat fork); direct 36.0.15 LTS | **Tracked** | 2 advisory ignores in `deny.toml` (mirrored in `.cargo/audit.toml`) | YARA compilation only for the transitive line; both lines version-patched (direct 36.0.15 LTS for RUSTSEC-2026-0269; transitive 47.0.4 for 0222/0269 + 2026-04 batch). Remaining ignores: `rsa` 0071 (no upstream fix), `rkyv` 0235. Reviewed: 2026-09-18; Re-audit: 2026-10-01. See `architecture/dependency_security_baseline_phase25.md` §11 |
