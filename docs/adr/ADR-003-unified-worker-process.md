...
## References
- `src/worker/unified_server/` - Main unified server implementation
- `src/worker/` - Worker process management
- `crates/synvoid-app-server/src/granian.rs` - AppServer/Granian integration
