...
pub struct ProxyCache {
    ...
    host_index: Arc<DashMap<String, Vec<CacheKey>>>,
    inflight_requests: InflightRequestsMap,
    inflight_revalidations: Arc<DashMap<CacheKey, ()>>,
    site_memory_usage: Arc<DashMap<String, AtomicU64>>,
...
impl Clone for ProxyCache {
    fn clone(&self) -> Self {
        Self {
            ...
            site_memory_usage: self.site_memory_usage.clone(),
...
impl ProxyCache {
    pub fn new(settings: ProxyCacheSettings) -> Self {
        ...
        Self {
            ...
            host_index: Arc::new(DashMap::new()),
            inflight_requests: Arc::new(DashMap::new()),
            inflight_revalidations: Arc::new(DashMap::new()),
            site_memory_usage: Arc::new(DashMap::new()),
