...
pub async fn get_capabilities<S: AdminStateProvider>(
...
pub async fn get_supervisor_status<S: AdminStateProvider>(
...
pub async fn get_system_info<S: AdminStateProvider>(
    State(_state): State<Arc<S>>,
    _auth: OptionalAuth,
...
pub async fn get_workers<S: AdminStateProvider>(
    State(state): State<Arc<S>>,
    _auth: OptionalAuth,
...
pub async fn restart_worker<S: AdminStateProvider>(
    State(state): State<Arc<S>>,
...
pub async fn batch_restart_workers<S: AdminStateProvider>(
    State(state): State<Arc<S>>,
    _auth: OptionalAuth,
...
pub async fn get_worker_count<S: AdminStateProvider>(
    State(state): State<Arc<S>>,
    _auth: OptionalAuth,
...
pub async fn scale_workers<S: AdminStateProvider>(
    State(state): State<Arc<S>>,
    _auth: OptionalAuth,
...
pub async fn get_supervisor<S: AdminStateProvider>(
    State(state): State<Arc<S>>,
    _auth: OptionalAuth,
...
pub async fn get_granian_logs<S: AdminStateProvider>(
    State(_state): State<Arc<S>>,
    _auth: OptionalAuth,
    Path(site_id): Path<String>,
) -> Result<Json<GranianLogsResponse>, StatusCode> {
    match synvoid_app_server::get_granian_logs(&site_id) {
