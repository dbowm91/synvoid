...
pub trait MeshMinificationConfigLike {
    ...
    fn enable_html(&self) -> Option<bool>;
    fn enable_css(&self) -> Option<bool>;
    fn enable_js(&self) -> Option<bool>;
}

pub trait MeshImageProtectionConfigLike {
    fn enabled(&self) -> Option<bool>;
    fn min_size_bytes(&self) -> Option<usize>;
    fn whitelist_patterns(&self) -> Option<&Vec<String>>;
}

pub trait MeshCompressionConfigLike {
    fn enabled(&self) -> Option<bool>;
    fn brotli_level(&self) -> Option<u32>;
    fn gzip_level(&self) -> Option<u32>;
}

impl MeshMinificationConfigLike for synvoid_config::MeshMinificationConfig {
    fn enabled(&self) -> Option<bool> {
        self.enabled
    }
...
impl MeshImageProtectionConfigLike for synvoid_config::MeshImageProtectionConfig {
    fn enabled(&self) -> Option<bool> {
        self.enabled
    }
    ...
    fn whitelist_patterns(&self) -> Option<&Vec<String>> {
        self.whitelist_patterns.as_ref()
    }
}

impl MeshCompressionConfigLike for synvoid_config::MeshCompressionConfig {
    fn enabled(&self) -> Option<bool> {
        self.enabled
    }
...
#[cfg(feature = "mesh")]
impl MeshMinificationConfigLike for synvoid_mesh::mesh::config::MeshMinificationConfig {
    fn enabled(&self) -> Option<bool> {
        self.enabled
    }
...
#[cfg(feature = "mesh")]
impl MeshImageProtectionConfigLike for synvoid_mesh::mesh::config::MeshImageProtectionConfig {
    fn enabled(&self) -> Option<bool> {
        self.enabled
    }
...
#[cfg(feature = "mesh")]
impl MeshCompressionConfigLike for synvoid_mesh::mesh::config::MeshCompressionConfig {
    fn enabled(&self) -> Option<bool> {
        self.enabled
    }
...
impl<'a> ResponseTransformConfig<'a> {
    #[cfg(feature = "mesh")]
    pub fn from_mesh_config<M, I, C>(
        minification: Option<&'a M>,
        image_protection: Option<&'a I>,
        compression: Option<&'a C>,
    ) -> Self
    where
        M: MeshMinificationConfigLike,
        I: MeshImageProtectionConfigLike,
        C: MeshCompressionConfigLike,
    {
