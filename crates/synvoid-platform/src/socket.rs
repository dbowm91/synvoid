...
#[cfg(unix)]
pub use crate::unix::UnixSocketFDPassing as PlatformSocketFDPassing;
#[cfg(unix)]
pub use crate::unix::UnixSocketHandle as PlatformSocketHandle;

#[cfg(windows)]
pub use crate::windows_impl::WindowsSocketFDPassing as PlatformSocketFDPassing;
#[cfg(windows)]
pub use crate::windows_impl::WindowsSocketHandle as PlatformSocketHandle;
...
pub fn create_listening_socket(port: u16, reuse_port: bool) -> Result<SocketInfo, PlatformError> {
    #[cfg(unix)]
    {
        crate::unix::create_listening_socket_unix(port, reuse_port)
    }

    #[cfg(windows)]
    {
        crate::windows_impl::create_listening_socket_windows(port)
    }
...
pub fn create_listening_socket_v6(
    ...
    #[cfg(unix)]
    {
        crate::unix::create_listening_socket_v6_unix(port, reuse_port)
    }

    #[cfg(windows)]
    {
        crate::windows_impl::create_listening_socket_v6_windows(port)
    }
