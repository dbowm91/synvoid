...
use crate::protocol::{DhtRecord, DhtRecordStatus};

use crate::dht::record_store::DhtRecordEntry;
    ...
    pub fn get(&self, key: &str) -> Option<DhtRecordEntry> {
        ...
        stmt.query_row(params![key], |row| {
            ...
            let quorum_proof = quorum_proof_bytes
                .map(|b| synvoid_utils::serialization::deserialize(&b).unwrap_or_default())
                .unwrap_or_default();
            Ok(DhtRecordEntry {
                record: DhtRecord {
                    key: row.get(0)?,
    ...
    pub fn insert(&self, key: String, value: DhtRecordEntry) -> Option<DhtRecordEntry> {
        ...
        conn.execute(
            ...
            params![
                ...
                synvoid_utils::serialization::serialize(&value.record.quorum_proof).ok(),
