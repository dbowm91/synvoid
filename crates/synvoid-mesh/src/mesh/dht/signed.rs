...
pub fn get_snapshot_request_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtSnapshotRequestSignable {
        request_id,
        node_id,
        from_version,
        timestamp,
...
pub fn get_sync_request_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtSyncRequestSignable {
        request_id,
        node_id,
        from_version,
        timestamp,
...
pub fn compute_record_set_digest(records: &[crate::protocol::DhtRecord]) -> Vec<u8> {
    use sha2::{Digest, Sha256};
...
pub fn get_dht_record_push_envelope_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtRecordPushEnvelopeSignable {
        request_id,
        node_id,
        record_keys,
...
pub fn get_snapshot_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtSnapshotResponseSignable {
        request_id,
        responder_node_id,
        version,
        record_count,
...
pub fn get_sync_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtSyncResponseSignable {
        request_id,
        from_peer,
        responder_node_id,
        version,
...
pub fn get_anti_entropy_request_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtAntiEntropyRequestSignable {
        request_id,
        node_id,
        local_root_hash,
        timestamp,
...
pub fn get_anti_entropy_response_signable_content(
    ...
    synvoid_utils::serialization::serialize(&DhtAntiEntropyResponseSignable {
        request_id,
        responder_node_id,
        root_hash,
        record_count,
...
pub fn get_quorum_proof_signable_content(
    ...
    synvoid_utils::serialization::serialize(&QuorumProofSignable {
        request_id,
        key: &record.key,
...
impl SignedDhtRecord {
    ...
    pub fn deserialize_postcard(data: &[u8]) -> Option<Self> {
        synvoid_utils::serialization::deserialize(data).ok()
    }
...
pub fn dht_record_to_signed_record(record: &crate::protocol::DhtRecord) -> SignedDhtRecord {
    let dht_key = crate::dht::keys::DhtKey::from_str(&record.key);
...
pub fn verify_dht_record_signature(record: &crate::protocol::DhtRecord) -> bool {
...
pub fn verify_quorum_proof(
    ...
    if record.quorum_proof.is_empty() {
        ...
        crate::stubs::metrics::record_dht_verification_failure();
        return false;
    }
    ...
    let required = if total_known_global_nodes == 0 {
        ...
        crate::dht::quorum::QuorumRequest::required_signatures_for(total_known_global_nodes)
            .max(MIN_QUORUM_PROOF_SIGNATURES)
    };

    let signable_content = get_quorum_proof_signable_content(request_id, record, action);
    let default_signer = crate::protocol::MeshMessageSigner::new([0u8; 32]);
...
pub fn verify_quorum_proof_with_context(
    ...
    let required = if quorum_nodes == 0 {
        ...
        crate::dht::quorum::QuorumRequest::required_signatures_for(quorum_nodes)
            .max(MIN_QUORUM_PROOF_SIGNATURES)
    };
...
mod tests {
    ...
    fn test_upstream_needs_refresh() {
        ...
        record.created_at = synvoid_utils::safe_unix_timestamp() - 100;
    ...
    fn test_verify_quorum_proof_insufficient_signatures_rejected() {
        let record = crate::protocol::DhtRecord {
            ...
            signer_public_key: Some("some_key".to_string()),
            content_hash: Vec::new(),
            quorum_proof: vec![crate::protocol::QuorumSignatureProto {
    ...
    fn test_verify_quorum_proof_valid_proof_accepted() {
        ...
        let signer1 = crate::protocol::MeshMessageSigner::new(secret1);
        let signer2 = crate::protocol::MeshMessageSigner::new(secret2);
        let signer3 = crate::protocol::MeshMessageSigner::new(secret3);
        ...
        let record = crate::protocol::DhtRecord {
            ...
            content_hash: Vec::new(),
            quorum_proof: vec![
                crate::protocol::QuorumSignatureProto {
                    node_id: "global1".to_string(),
                    signature: sig1,
                    timestamp: 1000,
    ...
    fn test_regression_forged_quorum_proof_with_fake_signatures_rejected() {
        let fake_signatures_record = crate::protocol::DhtRecord {
    ...
    fn test_regression_quorum_proof_signature_replay_to_different_content_rejected() {
        ...
        let record1 = crate::protocol::DhtRecord {
        ...
        let record2 = crate::protocol::DhtRecord {
    ...
    fn test_verify_for_ingress_rejects_expired() {
        ...
        let record = DhtRecord {
            key: "test_key".to_string(),
            value: b"test_value".to_vec(),
            timestamp: synvoid_utils::safe_unix_timestamp() - 7200,
            sequence_number: 0,
            ttl_seconds: 300,
            source_node_id: "node123".to_string(),
            signature: vec![],
    ...
    fn test_verify_quorum_proof_rejects_valid_key_wrong_node_id() {
        ...
        let signer = crate::protocol::MeshMessageSigner::new(secret);
    ...
    fn test_ingress_accepts_valid_remote_announce_with_signature() {
        use crate::config::MeshConfig;
        use crate::dht::DhtAccessControl;
        use crate::protocol::{DhtRecord, MeshMessageSigner};
        ...
        let signed_record = crate::dht::signed::dht_record_to_signed_record(&record);
