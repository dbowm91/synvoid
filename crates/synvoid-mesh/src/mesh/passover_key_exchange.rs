...
pub struct KeyExchangeHttpState {
    ...
    pub transport: Option<Arc<crate::transports::MeshTransportManager>>,
...
impl KeyExchangeHttpState {
    ...
    pub fn with_transport(
        mut self,
        transport: Option<Arc<crate::transports::MeshTransportManager>>,
    ) -> Self {
    ...
    pub async fn proxy_key_request_to_origin(
        ...
        let key_forward = crate::protocol::MeshMessage::KeyForward {
...
pub struct KeyExchangeService {
    ...
    mesh_transport: Option<Arc<crate::transport::MeshTransport>>,
    pending_key_requests: Arc<
        RwLock<std::collections::HashMap<String, tokio::sync::oneshot::Sender<KeySignedResponse>>>,
    >,
}
...
impl KeyExchangeService {
    ...
    pub fn with_transport(mut self, transport: Arc<crate::transport::MeshTransport>) -> Self {
...
fn build_cors_layer(global_node_config: &crate::config::GlobalNodeConfig) -> CorsLayer {
...
mod tests {
    ...
    fn test_global_node_config_key_loading() {
        use crate::config::GlobalNodeConfig;
