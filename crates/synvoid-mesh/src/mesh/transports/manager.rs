...
use crate::verification::{VerificationConfig, VerificationTaskManager};
...
pub struct MeshTransportManager {
    ...
    routing_manager: Arc<RwLock<Option<Arc<crate::dht::routing::DhtRoutingManager>>>>,
    verification_manager: Arc<VerificationTaskManager>,
    // Config caches with metrics
    image_protection_cache:
        Arc<RwLock<LruCache<String, (crate::config::MeshImageProtectionConfig, Instant)>>>,
    compression_cache:
...
impl MeshTransportManager {
    ...
    pub fn set_verification_record_store(&self, record_store: Arc<crate::dht::RecordStoreManager>) {
    ...
    pub fn report_reachability(
        ...
        status: crate::dht::ReachabilityStatus,
        latency_ms: u32,
        error_rate: f32,
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                for (task_key, _task_id, task) in tasks_to_dispatch {
                    ...
                    let query = crate::protocol::MeshMessage::UpstreamVerificationQuery {
    ...
    pub fn get_dns01_challenge(
        &self,
        txt_record_name: &str,
    ) -> Option<crate::transport::Dns01Challenge> {
        self.quic_transport
            .read()
            .as_ref()
        ...
        if let Some(ref record_store) = self.record_store {
            ...
            for capability in capabilities {
                ...
                let value = serde_json::json!({
                    ...
                    "announced_at": synvoid_utils::safe_unix_timestamp(),
                });
    ...
    pub async fn update_key_exchange_endpoint(&self) {
        ...
        use crate::transports::TransportHint;
    ...
    pub async fn get_image_protection_for_site(
        &self,
        upstream_id: &str,
    ) -> Option<crate::config::MeshImageProtectionConfig> {
    ...
    pub async fn get_compression_for_site(
        &self,
        upstream_id: &str,
    ) -> Option<crate::config::MeshCompressionConfig> {
        self.fetch_cached_config(
            upstream_id,
    ...
    pub async fn get_minification_for_site(
        &self,
        upstream_id: &str,
    ) -> Option<crate::config::MeshMinificationConfig> {
        self.fetch_cached_config(
            upstream_id,
    ...
    pub fn publish_upstream_transform_configs(
        &self,
        sites: &std::collections::HashMap<String, synvoid_config::site::SiteConfig>,
    ) {
        let Some(ref record_store) = self.record_store else {
