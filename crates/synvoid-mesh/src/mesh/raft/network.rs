...
impl RaftNetworkV2<crate::raft::state_machine::GlobalRegistryConfig>
    for MeshRaftNetwork<crate::raft::state_machine::GlobalRegistryConfig>
{
    async fn append_entries(
        &mut self,
        rpc: AppendEntriesRequest<crate::raft::state_machine::GlobalRegistryConfig>,
        _option: RPCOption,
    ) -> Result<
        AppendEntriesResponse<crate::raft::state_machine::GlobalRegistryConfig>,
        RPCError<crate::raft::state_machine::GlobalRegistryConfig>,
    > {
        let data =
    ...
    async fn vote(
        &mut self,
        rpc: VoteRequest<crate::raft::state_machine::GlobalRegistryConfig>,
        _option: RPCOption,
    ) -> Result<
        VoteResponse<crate::raft::state_machine::GlobalRegistryConfig>,
        RPCError<crate::raft::state_machine::GlobalRegistryConfig>,
    > {
        let data =
            postcard::to_stdvec(&rpc).map_err(|e| RPCError::Unreachable(Unreachable::new(&e)))?;
    ...
    async fn full_snapshot(
        &mut self,
        vote: VoteOf<crate::raft::state_machine::GlobalRegistryConfig>,
        snapshot: SnapshotOf<crate::raft::state_machine::GlobalRegistryConfig>,
    ...
    > {
        ...
        while offset < total_size {
            ...
            let chunk_info = crate::protocol::SnapshotChunk {
                request_id: request_id.clone(),
                offset,
                is_last,
                data: chunk,
            };
            let chunk_frame = crate::protocol::RaftSnapshotFrame::Chunk(chunk_info);
        ...
        let response: SnapshotResponse<crate::raft::state_machine::GlobalRegistryConfig> =
...
impl openraft::network::RaftNetworkFactory<crate::raft::state_machine::GlobalRegistryConfig>
    for MeshRaftNetworkFactory
{
    type Network = MeshRaftNetwork<crate::raft::state_machine::GlobalRegistryConfig>;

    async fn new_client(
        &mut self,
        target: <crate::raft::state_machine::GlobalRegistryConfig as openraft::RaftTypeConfig>::NodeId,
        _node: &<crate::raft::state_machine::GlobalRegistryConfig as openraft::RaftTypeConfig>::Node,
    ) -> Self::Network {
        tracing::debug!(
