...
use synvoid_config::site::BackendConfig;
use synvoid_config::site::PhpLocationConfig;
...
impl Router {
    ...
    pub fn with_plugin_manager(mut self, plugin_manager: Arc<dyn Any + Send + Sync>) -> Self {
        self.plugin_manager = Some(plugin_manager);
        self
    }

    pub fn plugin_manager(&self) -> Option<&Arc<dyn Any + Send + Sync>> {
