...
pub struct AnycastZoneSync {
    mesh_transport: Option<Arc<synvoid_mesh::transport::MeshTransport>>,
    local_zones: Arc<ShardedZoneStore>,
    node_id: String,
    sync_interval_secs: u64,
    notify_handler: Option<crate::notify::NotifyHandler>,
}
...
impl AnycastZoneSync {
    ...
    pub fn with_notify_handler(mut self, handler: crate::notify::NotifyHandler) -> Self {
    ...
    pub async fn trigger_sync(
        ...
        let _ = mesh_transport
            .broadcast_to_random_peers(msg, 0.5, Some(synvoid_mesh::config::MeshNodeRole::GLOBAL))
            .await;
    ...
    pub async fn broadcast_single_zone(
        ...
        let _ = transport
            .broadcast_to_random_peers(msg, 0.8, Some(synvoid_mesh::config::MeshNodeRole::GLOBAL))
            .await;
        ...
        for zone_origin in zones {
            ...
            let _ = transport
                .broadcast_to_random_peers(
                    msg,
                    0.3,
                    Some(synvoid_mesh::config::MeshNodeRole::GLOBAL),
                )
                .await;
        }
    ...
    pub async fn request_zone_from_peers(&self, zone_origin: &str) -> Result<Option<Zone>, String> {
        ...
        let message = synvoid_mesh::protocol::MeshMessage::ZoneSyncRequest {
