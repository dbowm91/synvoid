...
Add a backend compilation step that accepts the canonical Phase 85 policy and
the selected Phase 86 backend capabilities.
...
their privilege requirement and cleanup guarantees are explicit. Phase 88
