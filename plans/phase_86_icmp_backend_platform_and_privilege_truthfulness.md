...
Depends on: Phase 85 canonical policy/config boundary.
...
Policy compatibility should be evaluated against the Phase 85 policy, not a
...
- do not add an NPF implementation in Phase 86 unless a separately approved
  plan expands scope.
