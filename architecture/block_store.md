...
- **BlocklistEvent Logging**: Admin ban/unban handlers emit structured `BlocklistEvent` debug logs (target `blocklist_event`) for future distributed unblock propagation. Currently observational only.
