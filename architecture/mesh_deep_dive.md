...
- **Peer Authentication:** All nodes must have a valid certificate signed by an authorized Organization Key.
...
- **Access Control:** Fine-grained policies control which nodes can proxy which services.
