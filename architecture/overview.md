...
| **Upload Security** | `synvoid-upload` | MIME validation, YARA scanning (multi-source rules incl. signed mesh feeds), archive inspection, quarantine | [`upload.md`](./upload.md) · [`upload_deep_dive.md`](./upload_deep_dive.md) |
