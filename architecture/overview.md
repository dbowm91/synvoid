...
**H1 transport (Phases 73–80, adopted)**: plaintext and TLS-ALPN H1 production runs the pinned EggServe direct runtime (`eggserve-server = "=0.4.0"`, `eggserve-primitives = "=0.2.2"` with `http-interop`; no `eggserve-core` — bumped from 0.3.1/0.2.1 by Phase 79 Finding B, which 0.3.1 cannot satisfy) behind a transport-neutral inbound boundary — `crates/synvoid-http/src/inbound.rs` (neutral body/request/upgrade contract) + `hyper_adapter.rs` (Hyper H1/H2 ingress as one adapter) on the crate side, `src/http/eggserve_h1.rs` (caller-owned-stream adapter) + `src/http/service_core.rs` (shared policy/service core) on the root side. Hyper remains for H2, egress, and test-only differential lanes. Contract gates: `tests/http_transport_neutrality_guard.rs`, `tests/eggserve_h1_differential.rs`, `tests/eggserve_plaintext_adoption.rs`, `tests/eggserve_tls_h1_convergence.rs`, `tests/eggserve_h1_runtime_corrective.rs` (Phase 79 findings A–D) (+ manual-only perf `tests/eggserve_h1_perf.rs`).

Related: [`http_deep_dive.md`](./http_deep_dive.md) · [`http_server.md`](./http_server.md) · [`http_shared.md`](./http_shared.md) · [`http_ownership_convergence.md`](./http_ownership_convergence.md) · EggServe H1 chain (authoritative, newest first): [`eggserve_0_3_h1_adoption_closeout.md`](./eggserve_0_3_h1_adoption_closeout.md) (current Phase 80 corrected `ADOPTED` disposition; Phase 78's terminal claim was superseded) → [`eggserve_0_4_0_trailer_head_addendum.md`](./eggserve_0_4_0_trailer_head_addendum.md) (Phase 79 pin change) → [`eggserve_0_3_1_h1_requalification_addendum.md`](./eggserve_0_3_1_h1_requalification_addendum.md) → [`eggserve_0_3_h1_adapter_qualification.md`](./eggserve_0_3_h1_adapter_qualification.md) (Phase 75) → [`eggserve_0_3_h1_compatibility_matrix.md`](./eggserve_0_3_h1_compatibility_matrix.md) (Phase 73 0.3.0 record) · retained predecessors: [`eggserve_0_2_2_h1_compatibility_matrix.md`](./eggserve_0_2_2_h1_compatibility_matrix.md) · [`H1 runtime truthfulness (Phase 70)`](./http_h1_runtime_truthfulness_phase70.md) · [`HTTP config runtime semantics (Phase 71)`](./http_config_runtime_semantics_matrix.md) · [`streaming.md`](./streaming.md) · [`networking_deep_dive.md`](./networking_deep_dive.md)
