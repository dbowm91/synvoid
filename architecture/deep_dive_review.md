...
4.  **Control Plane gRPC:** The management interface is now a formal gRPC API (`proto/control.proto`) protected by TLS, providing a robust and typed interface for remote management.
