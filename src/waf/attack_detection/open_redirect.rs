...
lazy_static! {
    static ref REDIRECT_PARAM_AC: AhoCorasick = {
        let patterns = vec![
            "redirect", "url", "link", "goto", "next", "dest", "destination", "callback", "return",
            "page", "ref", "reference", "site", "html", "val", "validate", "domain", "continue", "c",
            "path", "dir", "show", "view", "doc", "img_url", "source", "src", "target", "to", "out",
            "viewpage", "open", "file", "document", "folder", "pg", "style", "return_path",
            "success_url", "error_url", "return_to", "return_url", "from_url", "redir_url",
            "redirect_uri", "redirect_url", "oauth_callback", "callback_url", "serve", "proxy",
            "bigimg", "url_link", "linkurl", "origin", "originUrl", "sourceUrl", "contentUrl",
            "shareUrl", "qpa", "query", "token", "email", "subject", "template", "func", "call",
            "mode", "name", "rest_url", "continue_url", "u", "urlfrom", "urlsrc",
        ];
