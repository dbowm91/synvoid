...
use crate::honeypot_port::storage::{HoneypotStorage, HoneypotRecord};
...
impl PortHoneypotListener {
    ...
    pub async fn find_available_port(&self, min_port: u16, max_port: u16, max_attempts: usize) -> Option<u16> {
        use rand::Rng;
