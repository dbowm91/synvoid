...
pub struct PortHoneypotController {
    ...
    config: Arc<RwLock<crate::config::honeypot_port::HoneypotPortConfig>>,
}

impl PortHoneypotController {
    pub fn new(
        runner: Arc<PortHoneypotRunner>,
        config: crate::config::honeypot_port::HoneypotPortConfig,
    ) -> Self {
        Self {
    ...
    pub fn from_runner(runner: Arc<PortHoneypotRunner>) -> Self {
        Self {
            ...
            config: Arc::new(RwLock::new(
                crate::config::honeypot_port::HoneypotPortConfig::default(),
            )),
        }
    }

    pub fn get_config(&self) -> crate::config::honeypot_port::HoneypotPortConfig {
        self.config.read().clone()
    }

    pub fn update_config(
        &self,
        new_config: crate::config::honeypot_port::HoneypotPortConfig,
    ) -> Result<(), String> {
    ...
    pub fn get_status(&self) -> crate::honeypot_port::mesh_control::HoneypotStatus {
        crate::honeypot_port::mesh_control::HoneypotStatus {
