...
impl CryptoVerificationPool {
    ...
    pub async fn verify_ml_dsa_with_signer(
        &self,
        signer: Arc<crate::mesh::ml_dsa::MeshMlDsaSigner>,
        message: &[u8],
        signature: &[u8],
    ) -> bool {
...
mod tests {
    ...
    async fn test_verify_ml_dsa_success() {
        ...
        let signer = crate::mesh::ml_dsa::MeshMlDsaSigner::generate();
    ...
    async fn test_verify_ml_dsa_with_signer() {
        let pool = CryptoVerificationPool::default_pool();
        let signer = Arc::new(crate::mesh::ml_dsa::MeshMlDsaSigner::generate());
