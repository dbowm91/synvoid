...
impl MeshTransport {
    ...
    pub(crate) async fn wait_for_peer_datagrams(
        &self,
    ) -> Option<(String, Bytes)> {
    ...
    pub(crate) async fn handle_peer_gone(
        &self,
        from_peer: &str,
        node_id: &str,
        reason: &str,
    ...
    pub(crate) async fn handle_route_usage_report(&self, upstream_id: &str, request_count: u64, bytes_transferred: u64) {
