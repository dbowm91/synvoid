...
impl HybridSignature {
    ...
    pub fn ed25519_only(ed25519_sig: Vec<u8>, signer_public_key: String) -> Self {
        Self {
            ed25519_signature: ed25519_sig,
    ...
    pub fn has_ml_dsa(&self) -> bool {
        !self.ml_dsa_signature.is_empty()
    }
...
mod tests {
    ...
    fn test_hybrid_signature_serialization() {
        ...
        assert_eq!(sig.signer_public_key, recovered.signer_public_key);
    }
