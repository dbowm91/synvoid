...
//!
//! Canonical owner: `synvoid_jail_runtime::YaraJailService`
//! (`crates/synvoid-jail-runtime/src/yara_service.rs`). This root module is a
...
pub use synvoid_jail_runtime::YaraJailService;
