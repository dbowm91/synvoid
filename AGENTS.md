...
- **spawn_auxiliary_task()**: `crates/synvoid-mesh/src/mesh/transport.rs:2821` — shared helper for auxiliary task registration with `AuxiliaryTaskExit` publication, dedup, and capacity gating.
